      ...
      >
        ...
        >
          <div class="lg:self-center">
            ...
            <g-link
              :to="brand.sourceUrl"
              class="mt-8 bg-white rounded shadow rounded-full px-8 py-2 inline-flex items-center text-base leading-6 font-medium text-gray-900 hover:text-indigo-500 hover:bg-gray-50 transition duration-150 ease-in-out"
              >{{ brand.btnTxt }}</g-link
            >
          </div>
        </div>
